...
require_once('../controladores/corOrigen.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('origen','codigo');
}
?>
...
<?php $objFunciones->botonera_general('Origen','total',$id); ?>
</div>
</form>
<!--
	Codigo
