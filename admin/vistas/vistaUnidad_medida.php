...
require_once('../controladores/corUnidad_medida.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('unidad_medida','codigo');
}
?>
...
<title>Gestion Unidad de Medida</title>
...
<tr>
<td align='right'><span class='rojo'>*</span> Siglas:</td>
<td><input type='text' disabled='disabled' maxlength='' name='txtsiglas' value='<?php print($lcSiglas);?>' id='txtsiglas' class='validate[required]'/></td>
</tr>
<tr>
...
<?php $objFunciones->botonera_general('Unidad_medida','total',$id); ?>
</div>
</form>
<!--
	Codigo
