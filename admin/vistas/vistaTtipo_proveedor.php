...
require_once('../controladores/corTtipo_proveedor.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('ttipo_proveedor','codigo');
}
?>
...
<title>Gestion Tipo Proveedor</title>
...
<?php $objFunciones->botonera_general('Ttipo_proveedor','total',$id); ?>
</div>
</form>
<!--
	Codigo
