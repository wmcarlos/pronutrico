...
require_once('../controladores/corTurno.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('turno','codigo');
}
?>
...
<?php $objFunciones->botonera_general('Turno','total',$id); ?>
</div>
</form>
<!--
	Codigo
