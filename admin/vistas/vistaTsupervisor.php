...
<td colspan="3"><input type='text' disabled='disabled' maxlength='' name='txtemail' value='<?php print($lcEmail);?>' id='txtemail' class=''/>@<select name='txtcodigo_dominio_correo' disabled='disabled' id='txtcodigo_dominio_correo'><option value=''>Seleccione</option>
