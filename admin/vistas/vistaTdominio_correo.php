...
require_once('../controladores/corTdominio_correo.php');
$objFunciones = new clsFunciones;
$operacion = $lcOperacion;
$listo = $lcListo;
if(($operacion!='buscar' && $listo!=1) || ($operacion!='buscar' && $listo==1))
{
$id = $objFunciones->ultimo_id_plus1('tdominio_correo','codigo');
}
?>
...
<title>Gestion Dominio Correo Electronico</title>
...
<h1>Dominio Correo Electronico</h1>
...
<?php $objFunciones->botonera_general('Tdominio_correo','total',$id); ?>
</div>
</form>
<!--
	Codigo
