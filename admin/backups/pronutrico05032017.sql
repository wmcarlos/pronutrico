...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-03-2017 a las 17:00:15
...
INSERT INTO `tentrada` (`nro_entrada`, `fecha_entrada`, `rif_proveedor`, `estatus`) VALUES
(1, '2016-10-01', '123456789', 1);
...
INSERT INTO `tlinea_entrada` (`codigo_linea_entrada`, `nro_entrada`, `codigo_producto`, `rif_transportista`, `chofer`, `placa`, `cantidad`) VALUES
(8, 1, 1, '445566777', 'billy diaz', 'A56AA5D', 26540),
(9, 1, 1, '634568976', 'ESPILLIMAN CHARACO', 'A28CM9S', 29600);
...
INSERT INTO `tlinea_salida` (`codigo_linea_salida`, `nro_salida`, `codigo_producto`, `cantidad`) VALUES
(15, 1, 2, 540);
...
(1, 'V', 'MAÃZ SECO', 'MP', 2, 3, 500000, 5000000, 45340, 1),
...
('123456789', 'CASA-IMPORTADORA', 1, 'ARAURE', 6, '6220987', 2, 'CASAIMPORTADORA', 1),
('223344556', 'CASA-SILOS GUACARA', 1, 'GUACARA', 5, '0984345', 1, 'SILOS_GUACARA', 1),
('334411890', 'LOGICASA', 2, 'LA GUAIRA', 2, '3345678', 1, 'LOGICASA', 1),
('445566777', 'SERV TRANSP FUFO', 2, 'ARAURE', 2, '4563738', 2, 'FUFO.TRANSPORTES', 1),
('634568976', 'ASOCI COOP PUERTO BOLIVAR', 2, 'BOLIVAR', 5, '4563234', 4, 'COOPBOLIVAR', 1),
('987654321', 'CASA-SILOS LA FLECHA', 1, 'ARAURE', 6, '6217156', 2, 'CASA.SILOS.LA.FLECHA', 1);
...
INSERT INTO `tsalida` (`nro_salida`, `fecha_salida`, `ceudula_supervisor`, `turno`, `estatus`) VALUES
(1, '2017-03-05', '19455542', 'T2', 1);
...
--
ALTER TABLE `tcodigo_area`
  MODIFY `codigo_area` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `tentrada`
  MODIFY `nro_entrada` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `tlinea_entrada`
--
ALTER TABLE `tlinea_entrada`
  MODIFY `codigo_linea_entrada` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT de la tabla `tlinea_salida`
--
ALTER TABLE `tlinea_salida`
  MODIFY `codigo_linea_salida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
...
--
ALTER TABLE `tsalida`
  MODIFY `nro_salida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
